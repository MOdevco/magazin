...
export default function ProductAbout({ about }) {
  ...
  return (
    <Box width={{ xl: "600px", md: "400px", base: "100%" }}>
      ...
      <Text mt="10px" cursor='pointer' color="#3182CE" display="flex" alignItems="center" className="clickme" onClick={() => setCollapse((prev) => !prev)}>Yana Ko'rish<IoIosArrowDown />{" "}
      </Text>
    </Box>
  );
}
